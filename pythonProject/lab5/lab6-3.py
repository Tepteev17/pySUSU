...
my_module.hello_world("zhenya")  # Вызовите функцию hello_world из модуля my_module
...
current_date = datetime.date(2023, 9, 10)
...
print(hello_world("zhenya"))  # Функция hello_world должна вызываться без указания модуля
