...
Список может быть записан в виде последовательности значений (элементов), разделенных запятыми, в квадратных скобках, например, lst = [item1, item2]. Списки могут содержать элементы разных типов, но обычно все элементы в списке одного типа.
